...
subrek_anying(){
xdg-open https://youtube.com/RendiNoober
sleep 10
}
m="\033[31;1m"
k="\033[1;33m"
...
clear
sleep 0.1
printf "${u}╔═╗╦═╗╔═╗╔╦╗     ${bi}╔═╗╔═╗╗  ╗";printf "\n${u}╚═╗╠═╝╠═╣║║║ ${m}<${h}•${m}> ${bi}║  ╠═╣║  ║";printf "\n${u}╚═╝╩  ╩ ╩╩ ╩     ${bi}╚═╝╩ ╩╚═╝╚═╝ ${k}New";printf "\n${b}══════════════════════════════════";printf "\n${b}=${m}[ ${pu}Author ${m}: ${bi}Randiansyah";printf "\n${b}=${m}[ ${pu}Youtube${m}: ${bi}Rendi Noober";printf "\n${b}=${m}[ ${pup}Github ${m}: ${hg}https://github.com/Rendi-ID${p}";printf "\n${b}══════════════════════════════════";sleep 0.1;printf $p"\n[${h}+${p}] ${k}Contoh ${m}: ${p}85xxxxxxxxx\n";gaskeun_lah_anying
}
gaskeun_lah_anying(){
	sleep 0.5
